...
public class AddNewCarTestsRest extends CarController {
    ...
    @Test
    public void addNewCarNegstiveTest_WrongToken(){
        ...
        CarDto car = CarDto.builder()
                ...
                .city("Haifa")
                .build();
        Assert.assertEquals(addNewCarResponse(car,"hjkhk123").getStatusCode(),401);
    }

    @Test
    public void addNewCarNegstiveTest_WOSerialNumber(){
